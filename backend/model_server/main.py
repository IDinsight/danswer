...
def get_model_app() -> FastAPI:
    application = FastAPI(title="ElectionGPT Model Server", version=__version__)
...
if __name__ == "__main__":
    logger.info(
        f"Starting ElectionGPT Model Server on http://{MODEL_SERVER_ALLOWED_HOST}:{str(MODEL_SERVER_PORT)}/"
    )
