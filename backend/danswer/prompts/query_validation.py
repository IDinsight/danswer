...
{QUESTION_PAT.upper()} HubGPT is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to HubGPT being unreachable. \
Assuming the documents from search contains situations where HubGPT is not reachable and \
