    ...
    <div className="mb-8">
      ...
      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup HubGPT to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets HubGPT should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message HubGPT to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
