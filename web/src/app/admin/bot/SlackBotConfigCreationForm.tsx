        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating UPGovGPT config - ${errorMsg}`
                  : `Error creating UPGovGPT config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
          ...
          {({ isSubmitting, values }) => (
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add UPGovGPT to the
                ...
                <SectionHeader>When should UPGovGPT respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @UPGovGPT Only"
                  subtext="If set, UPGovGPT will only respond when directly tagged"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, UPGovGPT responses will only be 
                  visible to members in this list. This is
                  useful if you want UPGovGPT to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of UPGovGPT's response / throw 
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents UPGovGPT uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that UPGovGPT should search
                                through. If left blank, UPGovGPT will search
