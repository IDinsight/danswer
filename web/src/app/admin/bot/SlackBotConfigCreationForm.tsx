        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating ElectionGPT config - ${errorMsg}`
                  : `Error creating ElectionGPT config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
          ...
          {({ isSubmitting, values }) => (
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add ElectionGPT to the
                ...
                <SectionHeader>When should ElectionGPT respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @ElectionGPT Only"
                  subtext="If set, ElectionGPT will only respond when directly tagged"
                />
                <BooleanFormField
                ...
                <TextArrayField
                  ...
                  subtext={`If specified, ElectionGPT responses will only be 
                  visible to members in this list. This is
                  useful if you want ElectionGPT to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of ElectionGPT's response / throw 
                ...
                <BooleanFormField
                  ...
                  label="Should ElectionGPT give a “Still need help?” button?"
                  subtext={`If specified, ElectionGPT's response will include a button at the bottom 
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;ElectionGPT Team&apos; or
                        &apos;ElectionGPT-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents ElectionGPT uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that ElectionGPT should search
                                through. If left blank, ElectionGPT will search
