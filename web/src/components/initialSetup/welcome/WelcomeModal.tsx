  ...
  switch (selectedFlow) {
    ...
    case "chat":
      ...
      body = (
        <>
          ...
          <div className="mt-3">
            <div>
              To start using HubGPT as a secure ChatGPT, we just need to
              configure our LLM!
              <br />
              <br />
              HubGPT supports connections with a wide range of LLMs, including
    ...
    default:
      ...
      body = (
        <>
          <div>
            <p>How are you planning on using HubGPT?</p>
          </div>
          <Divider />
          <UsageTypeSection
